...
zonal, the turnover that climate leaves unexplained should not be noise but zonal
...
That premise inherits a simplification of long standing. Since the foundational
...
architecture \PH{[cite: Todd-Brown 2013; Wieder 2013]}. Evidence accumulating over
...
Pedology suggests what the answer should be. If the properties that set persistence
arise from local soil context, they must carry spatial structure, and soils are
...
therefore inherit that zonal organisation. This is the hypothesis we put to the
data, and we state it plainly: the variation in turnover that climate does not
explain is not noise but zonal geography, the large-scale signature of persistence
as an emergent property.

We take a route complementary to mechanistic modelling. Rather than prescribe how
...
scattered; where context lengthens or shortens turnover; and how each driver acts.
The beyond-climate signal is modest in size but, we find, coherently organised and
ecologically interpretable (edaphic-led, with soil biology a distinct second axis);
mapped, it forms a zonal pattern of turnover; and that observation-based pattern
...
That the soil matrix should rival climate is, under the pedological reading, expected
...
coupling made visible, and it is why a zonal description is efficient rather than
redundant, carrying the shared climate signal and adding organised structure on top
of it.
...
a continuous profile of how the beyond-climate attribution changes from equator to
