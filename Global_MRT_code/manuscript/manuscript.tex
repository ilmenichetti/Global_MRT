...
attributable, organised, and mappable. On a common, spatially block
cross-validated footing, climate explains about a third of the predictable
variance in $\ln\tau$; an order-independent (Shapley) decomposition attributes the
rest to edaphic context (soil texture, mineralogy and chemistry; 33\,\%),
biological context (productivity and decomposer community; 22\,\%), and land use
...
% Addressed 2026-07-07 (Aleksi: aboveground litter / branches / all-BNPP-is-litter): carbon-input sensitivity in Sec.~\ref{sec:robust}, Fig.~\ref{fig:input_sensitivity}, Table~\ref{tab:input_sensitivity}.
...
% Addressed 2026-07-07 (Aleksi: forest harvest removals): a generous land-cover-based harvest export was applied on tree-dominant pixels and swept across the literature range of the export fraction; the beyond-climate signal does not fall (Sec.~\ref{sec:robust}, Fig.~\ref{fig:input_sensitivity}D). A dedicated managed-forest layer (e.g. Hansen/Lesiv) was judged unnecessary because the crude sweep already brackets the effect and it lands on the LandUse axis.
