...
primary productivity (BNPP). 
%Aleksi: For me this raises questions. How about branches. In most cases those are left on site, unless used for bioenergy. Are we now ignoring aboveground litter fraction ? And we assume that all NPP belowground is litter ? 
(maybe this is okay assumption?)
...
remaining distribution were removed prior to model fitting.
 ...
 %Aleksi: ow about harvests ? Most of the growth of forests is harvested and taken to mills in countries like Finland & Sweden: We would need layer of managed forests, like proxy based on this:  https://earthenginepartners.appspot.com/science-2013-global-forest And. then estimates of the fraction of NPP that is annually taken out of the system
% Aleksi: we could have biome spoecific values here if needed
...
% Aleksi: How about excluding peatlands? I think that it would be important ?  At least from the analysis, maybe maps can be as they are. But if we have obs from peatlands, those may distort our interpration ? (there are some global peat maps)
...
first-order at the local scale; predictors closer to the actual input flux, together
